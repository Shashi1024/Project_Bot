...
intents = json.loads(open("Nrm_1/DepIntents.json").read())
...
pickle.dump(words, open('Nrm_1/DepWords.pkl','wb'))
pickle.dump(classes, open('Nrm_1/DepClasses.pkl','wb'))
...
model.save('Nrm_1/DepPredict_eitk.h5', hist)
print('Done')
